CARDSHARK v0.8c2 - Open Source Cirrus Logic CL-GD543x Based VLB VGA Card

As it says on the package. This card supports a maximum memory size of 2MB, using traditional multiple-CAS FPM 256Kx16 SOJ memory. CL-GD5436 can use EDO memory. 60ns or faster is recommended.
